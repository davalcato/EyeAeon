...
struct MainPageView: View {
    ...
    @State private var isRecording = false  // Define isRecording
    @State private var transcriptionText = ""  // Define transcriptionText
    @State private var showCamera = false  // Define showCamera
    ...
    var body: some View {
                    ...
                    VStack(spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 5) {
                            ...
                            NavigationLink(destination: AnalyticsDashboardView()) {
                                Text("Go to Analytics Dashboard")
        ...
        .fullScreenCover(isPresented: $showCamera) {
            CameraView(isRecording: $isRecording, transcriptionText: $transcriptionText)  // Use bindings
        }
    }
